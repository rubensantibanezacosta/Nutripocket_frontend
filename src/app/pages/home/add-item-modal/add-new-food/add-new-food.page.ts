...
export class AddNewFoodPage {
  ...
  constructor(private modalController:ModalController, private formBuilder: FormBuilder, private foodService:FoodService) { 
  ...
  this.newFoodForm = this.formBuilder.group({
    ...
    calories100g: new FormControl("", Validators.compose([
      Validators.required,
      Validators.max(1000)
    ])),
    protein100g: new FormControl("", Validators.compose([
      Validators.required,
      Validators.max(100)
    ])),
    carbs100g: new FormControl("", Validators.compose([
      Validators.required,
      Validators.max(100)
    ])),
    sugar100g: new FormControl("", Validators.compose([
      Validators.required,
      Validators.max(100)
    ])),
    fat100g: new FormControl("", Validators.compose([
      Validators.required,
      Validators.max(100)
    ])),
    doseg: new FormControl("", Validators.compose([
      Validators.required,
      Validators.max(1000),
      Validators.min(1)
    ])),
    saturatedfat100g: new FormControl("", Validators.compose([
      Validators.max(100),
    ])),
    fiber100g: new FormControl("", Validators.compose([
      Validators.max(100),
    ])),
    salt100g: new FormControl("", Validators.compose([
      Validators.max(100),
    ])),
    dose: new FormControl("", Validators.compose([
      Validators.required,
      Validators.max(5000)
    ])),
  })
